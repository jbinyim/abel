				...
				<div class="row">
					<div class="col-lg-8 col-md-8">
						...
						<form action="${contextPath }/admin/beneficiart/adminBeneficiartAdd" method="post" enctype="multipart/form-data">
							...
							<div class="mt-10">
								<p>수혜자 소개</p>
								<input type="text" name="beneficiartComment" placeholder="수혜자 소개."
									onfocus="this.placeholder = ''" onblur="this.placeholder = '수혜자 소개.'" required
									class="single-input">
							</div>
							<div class="mt-10">
								<p>후원금액</p>
								<input type="text" name="contribution" placeholder="후원금액."
									onfocus="this.placeholder = ''" onblur="this.placeholder = '후원금액.'" required
									class="single-input">
							</div>
							<div class="mt-10">
								<p> 수혜자 생년월일</p>
